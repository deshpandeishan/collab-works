...
# from flask_login import current_user, login_required, redirect, url_for
...
#         return redirect(url_for('chat_page'))  # or your actual login page

#     # Find an existing conversation id or create a new one
#     conv = (
